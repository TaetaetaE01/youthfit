...
| F-09 | 마감일 이메일 알림 | 북마크한 정책의 마감 N일 전 이메일 알림 | P2 |
...
- 이메일 내용에 포함: 정책명, 마감일, YouthFit 상세 페이지 링크, 공식 신청 채널 링크
...
| NotificationSetting | user | userId, emailEnabled, daysBeforeDeadline |
