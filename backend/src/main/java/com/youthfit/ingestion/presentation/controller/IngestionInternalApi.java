...
public interface IngestionInternalApi {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Internal API Key 누락 / 불일치 (YF-002)")
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "인증 실패 (YF-002)"),
            @ApiResponse(responseCode = "400", description = "필수 파라미터 누락 (YF-001)")
    })
