...
export default function AdminRagPreviewPage() {
  ...
  return (
    <div className="p-6">
      {/* mobile fallback — visible only below md breakpoint */}
      <div className="flex flex-col items-center justify-center py-24 text-center md:hidden">
        <p className="text-sm text-neutral-500">데스크톱 화면에서 사용해주세요.</p>
      </div>
